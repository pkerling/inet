...
cModule *GenericRoutingTable::getHostModule()
{
    return findContainingNode(this);
}

IGenericRoutingTable *GenericRoutingTable::asGeneric()
{
    if (!adapter)
...
void GenericRoutingTable::deleteInterfaceRoutes(InterfaceEntry *entry)
{
    bool changed = false;
...
void GenericRoutingTable::invalidateCache()
{
    routingCache.clear();
...
void GenericRoutingTable::printMulticastRoutingTable() const
{
...
std::vector<IPv4Address> GenericRoutingTable::gatherAddresses() const
{
...
void GenericRoutingTable::configureInterfaceForIPv4(InterfaceEntry *ie)
{
...
InterfaceEntry *GenericRoutingTable::getInterfaceByAddress(const IPv4Address& addr) const
{
...
void GenericRoutingTable::configureLoopbackForIPv4()
{
...
bool GenericRoutingTable::isLocalAddress(const IPv4Address& dest) const
{
...
bool GenericRoutingTable::isLocalBroadcastAddress(const IPv4Address& dest) const
{
...
InterfaceEntry *GenericRoutingTable::findInterfaceByLocalBroadcastAddress(const IPv4Address& dest) const
{
    for (int i=0; i<ift->getNumInterfaces(); i++)
    {
        InterfaceEntry *ie = ift->getInterface(i);
...
bool GenericRoutingTable::isLocalMulticastAddress(const IPv4Address& dest) const
{
...
void GenericRoutingTable::purge()
{
    bool deleted = false;
...
IPv4Route *GenericRoutingTable::findBestMatchingRoute(const IPv4Address& dest) const
{
...
InterfaceEntry *GenericRoutingTable::getInterfaceForDestAddr(const IPv4Address& dest) const
{
...
IPv4Address GenericRoutingTable::getGatewayForDestAddr(const IPv4Address& dest) const
{
...
const IPv4MulticastRoute *GenericRoutingTable::findBestMatchingMulticastRoute(const IPv4Address &origin, const IPv4Address &group) const
{
...
IPv4Route *GenericRoutingTable::getRoute(int k) const
{
...
IPv4Route *GenericRoutingTable::getDefaultRoute() const
{
...
bool GenericRoutingTable::routeLessThan(const IPv4Route *a, const IPv4Route *b)
{
...
void GenericRoutingTable::setRouterId(IPv4Address a)
{
    routerId = a;
}

void GenericRoutingTable::internalAddRoute(IPv4Route *entry)
{
...
void GenericRoutingTable::addRoute(IPv4Route *entry)
{
...
IPv4Route *GenericRoutingTable::internalRemoveRoute(IPv4Route *entry)
{
...
IPv4Route *GenericRoutingTable::removeRoute(IPv4Route *entry)
{
...
bool GenericRoutingTable::deleteRoute(IPv4Route *entry)
{
...
bool GenericRoutingTable::multicastRouteLessThan(const IPv4MulticastRoute *a, const IPv4MulticastRoute *b)
{
...
void GenericRoutingTable::internalAddMulticastRoute(IPv4MulticastRoute *entry)
{
...
void GenericRoutingTable::addMulticastRoute(IPv4MulticastRoute *entry)
{
...
IPv4MulticastRoute *GenericRoutingTable::internalRemoveMulticastRoute(IPv4MulticastRoute *entry)
{
...
IPv4MulticastRoute *GenericRoutingTable::removeMulticastRoute(IPv4MulticastRoute *entry)
{
...
bool GenericRoutingTable::deleteMulticastRoute(IPv4MulticastRoute *entry)
{
...
void GenericRoutingTable::routeChanged(IPv4Route *entry, int fieldCode)
{
...
void GenericRoutingTable::multicastRouteChanged(IPv4MulticastRoute *entry, int fieldCode)
{
...
void GenericRoutingTable::updateNetmaskRoutes()
{
