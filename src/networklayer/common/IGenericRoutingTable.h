...
class Address {
    public:
        ...
        MAC48Address getMAC48Address();  // IEU-48
};
...
//    virtual void configureInterfaceForIPv4(InterfaceEntry *ie) = 0;
     ...
     */
    virtual InterfaceEntry *getInterfaceByAddress(const Address& address) const = 0;
    //@}

    /**
     * Forwarding on/off
     */
    virtual bool isForwardingEnabled() = 0;  //XXX IP modulba?

    /**
     * IPv4 multicast forwarding on/off
     */
    virtual bool isMulticastForwardingEnabled() = 0; //XXX IP modulba?

    /**
     * Returns routerId.
     */
    virtual Address getRouterId() = 0;

//    /**
//     * Sets routerId.
//     */
//    virtual void setRouterId(Address a) = 0;  //????
     ...
     */
    virtual InterfaceEntry *findInterfaceByLocalBroadcastAddress(const Address& dest) const = 0;  //XXX findInterfaceByLocalAddress() missing??
     ...
     */
    virtual InterfaceEntry *getInterfaceForDestAddr(const Address& dest) const = 0;  //XXX redundant
     ...
     */
    virtual Address getGatewayForDestAddr(const Address& dest) const = 0; //XXX redundant AND unused
    //@}
     ...
     */
    virtual const IGenericMulticastRoute *findBestMatchingMulticastRoute(const Address &origin, const Address& group) const = 0;
    //@}
     ...
     */
    virtual void purge() = 0; //XXX rename to purgeExpiredRoutes(), and rename isValid() to !isExpired()

    /**
     * Utility function: Returns a vector of all addresses of the node.
     */
    virtual std::vector<Address> gatherAddresses() const = 0; //XXX into InterfaceTable?
