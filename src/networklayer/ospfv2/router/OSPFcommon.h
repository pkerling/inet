...
{
    return IPvXAddressResolver().resolve(charForm, IPvXAddressResolver::ADDR_IPv4).toIPv4();
}

inline IPv4Address ipv4NetmaskFromAddressString(const char* charForm)
{
    return IPvXAddressResolver().resolve(charForm, IPvXAddressResolver::ADDR_IPv4|IPvXAddressResolver::ADDR_MASK).toIPv4();
}
